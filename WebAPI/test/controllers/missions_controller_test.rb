...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { body: @mission.body, closed: @mission.closed, difficulty: @mission.difficulty }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { body: @mission.body, closed: @mission.closed, difficulty: @mission.difficulty }
    assert_redirected_to mission_path(assigns(:mission))
  end
